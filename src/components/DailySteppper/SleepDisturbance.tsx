...
import { setSleepDisturbance, setCurrentStep } from "../../../redux/features/dailyQuestionsSlice";
    ...
    return (
        <div>
            <label className="block text-xs sm:text-sm lg:text-lg font-medium mb-2">
                How often have you experienced disturbances during sleep (e.g., waking up
                frequently, trouble falling asleep)?
            </label>
                ...
                {["Never", "Rarely", "Occasionally", "Frequently", "Every night"].map(
                    (disturbance) => (
                        <button
                            ...
                            style={{
                                backgroundColor:
                                    selectedSleepDisturbance === disturbance ? "#dbeafe" : "white",
                            }}
                        >
                            {disturbance}
                        </button>
