...
import { setMood, setCurrentStep } from "../../../redux/features/dailyQuestionsSlice"; // Update import based on your slice
...
const Mood = () => {
    ...
    const selectedMood = useSelector((state: RootState) => state.dailyQuestionsSlice.mood);
    ...
    return (
        <div>
            ...
            <div className={smallButtonsPaddingStyles}>
                {["Very positive", "Positive", "Neutral", "Negative", "Very negative"].map(
                    (mood) => (
                        <button
                            key={mood}
