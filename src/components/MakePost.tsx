...
import image1  from "@/public/trophy.png"

export default function MakePost() {
   const achievements = [
      { name: "Personal Achievement", image: "@/public/trophy.png" },
      { name: "Celebration", image: "/party.png" },
      { name: "Thoughts", image: "/thought.png" },
   ];

   const currentUser = "66dbdb7f346232b99cd41272";
                        ...
                        <div className="flex flex-row gap-3 flex-wrap">
                           {achievements.map((item, index) => (
                              <div
                                 ...
                                 onClick={() =>
                                    handleAchievementChange(item.name)
                                 }
                                 key={index}
                              >
                                 {item.name}
