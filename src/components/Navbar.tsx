...
import { setLogoutUser, setUserForGoogleSignup } from "../../redux/features/userSlice";
         ...
         <header className="relative w-full min-w-min box-border bg-white mt-4 rounded-[90px] md:rounded-[99px] shadow-navbarShadow">
            <div className="px-2 py-1 md:px-3">
               <div className="object-contain flex justify-between items-center relative">
                     ...
                     <ul className="nav-items flex md:ml-0 lg:gap-x-[20%] md:gap-x-4 gap-x-2 text-black items-center">
                        ...
                        <li>
                           <a
                              ...
                              className="hover:text-blue-600 text-xs lg:text-base"
                              onClick={() =>
                                 dispatch(setActivePage("/communitypost"))
                              }
                           >
                              Community
                           </a>
                  ...
                  <div className="gapper flex items-center gap-x-2 sm:gap-x-4 lg:gap-x-4 relative">
                     <button
                     ...
                     <div className="rounded-full box-border w-8 h-8 sm:w-10 sm:h-10 bg-[#D9D9D9] overflow-hidden relative cursor-pointer "onClick={handelShow}>
                        {userData.avatar ? (
                           <div className=" ">
                              <img
                                 src={userData.avatar}
