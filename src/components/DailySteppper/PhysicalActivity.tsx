...
import { setPhysicalActivity, setCurrentStep } from "../../../redux/features/dailyQuestionsSlice";
    ...
    return (
        <div>
            <label className="block text-xs sm:text-sm lg:text-lg font-medium mb-2">
                How frequently have you engaged in physical activity or exercise in the past week?
            </label>
            <div className={smallButtonsPaddingStyles}>
                {["Never", "1-2 times", "3-4 times", "5-6 times", "Daily"].map((activity) => (
                    <button
                        key={activity}
