...
import { setMoodDuration, setCurrentStep } from "../../../redux/features/dailyQuestionsSlice"; // Update import based on your slice
    ...
    return (
        <div>
            <label className="block text-xs sm:text-sm lg:text-lg font-medium mb-2">
                How long have you been feeling your current mood (e.g., positive or negative)?
            </label>
