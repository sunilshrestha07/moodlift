...
import { setAnxietySymptoms, setCurrentStep } from "../../../redux/features/dailyQuestionsSlice";
    ...
    return (
        <div>
            <label className="block text-xs sm:text-sm lg:text-lg font-medium mb-2">
                In the past week, how often have you experienced feelings of anxiety or worry?
            </label>
