...
const Initstep = () => {
    ...
    const currentStep = useSelector((state: RootState) => state.initialQsnSlice.currentStep); // Access state from the specific slice
    const [isClient, setIsClient] = useState(false);

    const steps: string[] = ["AGE", "GENDER", "Traumatic effect", "Mental health"];
        ...
        <>
            <div className="flex ">
                <div className=" bg-white p-6 rounded-lg shadow-lg w-full">
                    <h2 className="text-xl font-semibold mb-4">Please fill up this form</h2>
